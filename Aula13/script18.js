function carregar(){
    ...
    if(agr >= 6 && agr < 12){
        image.src = "depositphotos_66946055-stock-photo-cup-of-coffee.jpg"
        document.body.style = "background-color: #beige;"
    }else if(agr >= 12 && agr < 18){
        image.src = "bela-arquitetura-edificio-cidade-taipei.jpg"
        image.style = "transform: translate(-70%, -50%)"
        document.body.style = "background-color: #cE9e00;"
    }else{
        image.src = "noite-na-praia-com-barco-e-luar_104785-846.avif"
